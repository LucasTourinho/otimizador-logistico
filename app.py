...
# Criar as abas
tab1, tab2, tab3 = st.tabs(["Premissas", "Dados Atuais", "Resultados"])
...
# Aba 2: Dados Atuais
with tab2:
    st.header("Dados da Frota e CDs Atuais")
    ...
    if use_sample_data or uploaded_file is not None:
        try:
            ...
            if not all(col in data.columns for col in required_columns):
                ...
                # Header único para o comparativo
                ...
                # Cenário Proposto
                with st.spinner("Calculando cenário proposto..."):
